...
// Tue Jun 16 15:32:32 2015 by ROOT version 5.34/18
// from TTree PreSelection/PreSelection
// found on file: TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola/job_0_ReducedSelection.root
//////////////////////////////////////////////////////////

#ifndef MTW_studies_h
#define MTW_studies_h
...
class MTW_studies : public TSelector {
public :
   ...
   Float_t         selectedIDIsoElectronsPt[2];   //[selectedIDIsoElectronsNum]
   Float_t         selectedIDIsoElectronsEta[2];   //[selectedIDIsoElectronsNum]
   Float_t         selectedIDIsoElectronsPhi[2];   //[selectedIDIsoElectronsNum]
   Float_t         selectedIDIsoElectronsE[2];   //[selectedIDIsoElectronsNum]
   Float_t         selectedIDIsoElectrons_MTW[2];   //[selectedIDIsoElectronsNum]
   UShort_t        selectedIDElectronsNum;
   Float_t         selectedIDElectronsPt[3];   //[selectedIDElectronsNum]
   Float_t         selectedIDElectronsEta[3];   //[selectedIDElectronsNum]
   Float_t         selectedIDElectronsPhi[3];   //[selectedIDElectronsNum]
   Float_t         selectedIDElectronsE[3];   //[selectedIDElectronsNum]
   Float_t         selectedIDElectrons_MTW[3];   //[selectedIDElectronsNum]
   ...
   Float_t         selectedIDIsoMuonsNoMiniIsoPt[2];   //[selectedIDIsoMuonsNoMiniIsoNum]
   Float_t         selectedIDIsoMuonsNoMiniIsoEta[2];   //[selectedIDIsoMuonsNoMiniIsoNum]
   Float_t         selectedIDIsoMuonsNoMiniIsoPhi[2];   //[selectedIDIsoMuonsNoMiniIsoNum]
   Float_t         selectedIDIsoMuonsNoMiniIsoE[2];   //[selectedIDIsoMuonsNoMiniIsoNum]
   UShort_t        selectedIDIsoElectronsNoMiniIsoNum;
   Float_t         selectedIDIsoElectronsNoMiniIsoPt[2];   //[selectedIDIsoElectronsNoMiniIsoNum]
   Float_t         selectedIDIsoElectronsNoMiniIsoEta[2];   //[selectedIDIsoElectronsNoMiniIsoNum]
   Float_t         selectedIDIsoElectronsNoMiniIsoPhi[2];   //[selectedIDIsoElectronsNoMiniIsoNum]
   ...
   Float_t         slimmedElectronsPt[11];   //[slimmedElectronsNum]
   Float_t         slimmedElectronsEta[11];   //[slimmedElectronsNum]
   Float_t         slimmedElectronsPhi[11];   //[slimmedElectronsNum]
   Float_t         slimmedElectronsE[11];   //[slimmedElectronsNum]
   UShort_t        slimmedMuonsNum;
   Float_t         slimmedMuonsPt[17];   //[slimmedMuonsNum]
   Float_t         slimmedMuonsEta[17];   //[slimmedMuonsNum]
   Float_t         slimmedMuonsPhi[17];   //[slimmedMuonsNum]
   ...
   MTW_studies(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~MTW_studies() { }
   ...
   ClassDef(MTW_studies,0);
};

#endif

#ifdef MTW_studies_cxx
void MTW_studies::Init(TTree *tree)
{
