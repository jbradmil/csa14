...
cfA::cfA(const std::string& fileIn, const bool isList):
  ...
  jets_AKPF_et(0),
  jets_AKPF_energy(0),
  jets_AKPF_parton_Id(0),
  jets_AKPF_parton_motherId(0),
  jets_AKPF_parton_pt(0),
  jets_AKPF_parton_phi(0),
  jets_AKPF_parton_eta(0),
  jets_AKPF_parton_Energy(0),
  jets_AKPF_parton_mass(0),
  jets_AKPF_gen_et(0),
  jets_AKPF_gen_pt(0),
  jets_AKPF_gen_eta(0),
  jets_AKPF_gen_phi(0),
  jets_AKPF_gen_mass(0),
  jets_AKPF_gen_Energy(0),
  jets_AKPF_gen_Id(0),
  jets_AKPF_gen_motherID(0),
  jets_AKPF_gen_threeCharge(0),
  jets_AKPF_partonFlavour(0),
  jets_AKPF_btag_TC_highPur(0),
  jets_AKPF_btag_TC_highEff(0),
  jets_AKPF_btag_jetProb(0),
  jets_AKPF_btag_jetBProb(0),
  jets_AKPF_btag_softEle(0),
  jets_AKPF_btag_softMuon(0),
  ...
  jets_AKPF_chgEmE(0),
  jets_AKPF_chgHadE(0),
  jets_AKPF_photonEnergy(0),
  jets_AKPF_chgMuE(0),
  jets_AKPF_chg_Mult(0),
  jets_AKPF_neutralEmE(0),
  jets_AKPF_neutralHadE(0),
  jets_AKPF_neutral_Mult(0),
  jets_AKPF_mu_Mult(0),
  jets_AKPF_emf(0),
  jets_AKPF_ehf(0),
  jets_AKPF_n60(0),
  jets_AKPF_n90(0),
  jets_AKPF_etaetaMoment(0),
  jets_AKPF_etaphiMoment(0),
  jets_AKPF_phiphiMoment(0),
  jets_AKPF_n90Hits(0),
  jets_AKPF_fHPD(0),
  jets_AKPF_fRBX(0),
  jets_AKPF_hitsInN90(0),
  jets_AKPF_nECALTowers(0),
  jets_AKPF_nHCALTowers(0),
  jets_AKPF_fSubDetector1(0),
  jets_AKPF_fSubDetector2(0),
  jets_AKPF_fSubDetector3(0),
  jets_AKPF_fSubDetector4(0),
  jets_AKPF_area(0),
  jets_AKPF_corrFactorRaw(0),
  jets_AKPF_rawPt(0),
  jets_AKPF_mass(0),
  Njets_AK5PFclean(0),
  ...
  b_jets_AKPF_et(),
  b_jets_AKPF_energy(),
  b_jets_AKPF_parton_Id(),
  b_jets_AKPF_parton_motherId(),
  b_jets_AKPF_parton_pt(),
  b_jets_AKPF_parton_phi(),
  b_jets_AKPF_parton_eta(),
  b_jets_AKPF_parton_Energy(),
  b_jets_AKPF_parton_mass(),
  b_jets_AKPF_gen_et(),
  b_jets_AKPF_gen_pt(),
  b_jets_AKPF_gen_eta(),
  b_jets_AKPF_gen_phi(),
  b_jets_AKPF_gen_mass(),
  b_jets_AKPF_gen_Energy(),
  b_jets_AKPF_gen_Id(),
  b_jets_AKPF_gen_motherID(),
  b_jets_AKPF_gen_threeCharge(),
  b_jets_AKPF_partonFlavour(),
  b_jets_AKPF_btag_TC_highPur(),
  b_jets_AKPF_btag_TC_highEff(),
  b_jets_AKPF_btag_jetProb(),
  b_jets_AKPF_btag_jetBProb(),
  b_jets_AKPF_btag_softEle(),
  b_jets_AKPF_btag_softMuon(),
  ...
  b_jets_AKPF_chgEmE(),
  b_jets_AKPF_chgHadE(),
  b_jets_AKPF_photonEnergy(),
  b_jets_AKPF_chgMuE(),
  b_jets_AKPF_chg_Mult(),
  b_jets_AKPF_neutralEmE(),
  b_jets_AKPF_neutralHadE(),
  b_jets_AKPF_neutral_Mult(),
  b_jets_AKPF_mu_Mult(),
  b_jets_AKPF_emf(),
  b_jets_AKPF_ehf(),
  b_jets_AKPF_n60(),
  b_jets_AKPF_n90(),
  b_jets_AKPF_etaetaMoment(),
  b_jets_AKPF_etaphiMoment(),
  b_jets_AKPF_phiphiMoment(),
  b_jets_AKPF_n90Hits(),
  b_jets_AKPF_fHPD(),
  b_jets_AKPF_fRBX(),
  b_jets_AKPF_hitsInN90(),
  b_jets_AKPF_nECALTowers(),
  b_jets_AKPF_nHCALTowers(),
  b_jets_AKPF_fSubDetector1(),
  b_jets_AKPF_fSubDetector2(),
  b_jets_AKPF_fSubDetector3(),
  b_jets_AKPF_fSubDetector4(),
  b_jets_AKPF_area(),
  b_jets_AKPF_corrFactorRaw(),
  b_jets_AKPF_rawPt(),
  b_jets_AKPF_mass(),
  b_Njets_AK5PFclean(),
...
void cfA::GetCMEnergy(){
  size_t pos(sampleName.rfind("TeV"));
  pos=sampleName.find_last_of("_",pos);
  if(pos!=std::string::npos && pos<sampleName.size()-2){
    std::istringstream iss(sampleName.substr(pos+1));
    iss >> cmEnergy;
    if(iss.fail() || iss.bad()){
      cmEnergy=-1;
    }
...
void cfA::InitializeB(){
  ...
  if (cmEnergy>8) {
    ...
    chainB.SetBranchAddress("jets_AK4_pt", &jets_AKPF_pt, &b_jets_AKPF_pt);
    chainB.SetBranchAddress("jets_AK4_pz", &jets_AKPF_pz, &b_jets_AKPF_pz);
    chainB.SetBranchAddress("jets_AK4_px", &jets_AKPF_px, &b_jets_AKPF_px);
    chainB.SetBranchAddress("jets_AK4_py", &jets_AKPF_py, &b_jets_AKPF_py);
    chainB.SetBranchAddress("jets_AK4_eta", &jets_AKPF_eta, &b_jets_AKPF_eta);
    chainB.SetBranchAddress("jets_AK4_theta", &jets_AKPF_theta, &b_jets_AKPF_theta);
    chainB.SetBranchAddress("jets_AK4_et", &jets_AKPF_et, &b_jets_AKPF_et);
    chainB.SetBranchAddress("jets_AK4_energy", &jets_AKPF_energy, &b_jets_AKPF_energy);
    chainB.SetBranchAddress("jets_AK4_parton_Id", &jets_AKPF_parton_Id, &b_jets_AKPF_parton_Id);
    chainB.SetBranchAddress("jets_AK4_parton_motherId", &jets_AKPF_parton_motherId, &b_jets_AKPF_parton_motherId);
    chainB.SetBranchAddress("jets_AK4_parton_pt", &jets_AKPF_parton_pt, &b_jets_AKPF_parton_pt);
    chainB.SetBranchAddress("jets_AK4_parton_phi", &jets_AKPF_parton_phi, &b_jets_AKPF_parton_phi);
    ...
    chainB.SetBranchAddress("jets_AK4_photonEnergy", &jets_AKPF_photonEnergy, &b_jets_AKPF_photonEnergy);
    chainB.SetBranchAddress("jets_AK4_chgMuE", &jets_AKPF_chgMuE, &b_jets_AKPF_chgMuE);
    chainB.SetBranchAddress("jets_AK4_chg_Mult", &jets_AKPF_chg_Mult, &b_jets_AKPF_chg_Mult);
    chainB.SetBranchAddress("jets_AK4_neutralEmE", &jets_AKPF_neutralEmE, &b_jets_AKPF_neutralEmE);
    chainB.SetBranchAddress("jets_AK4_neutralHadE", &jets_AKPF_neutralHadE, &b_jets_AKPF_neutralHadE);
    chainB.SetBranchAddress("jets_AK4_neutral_Mult", &jets_AKPF_neutral_Mult, &b_jets_AKPF_neutral_Mult);
    chainB.SetBranchAddress("jets_AK4_mu_Mult", &jets_AKPF_mu_Mult, &b_jets_AKPF_mu_Mult);
    chainB.SetBranchAddress("jets_AK4_emf", &jets_AKPF_emf, &b_jets_AKPF_emf);
    chainB.SetBranchAddress("jets_AK4_ehf", &jets_AKPF_ehf, &b_jets_AKPF_ehf);
    chainB.SetBranchAddress("jets_AK4_n60", &jets_AKPF_n60, &b_jets_AKPF_n60);
    chainB.SetBranchAddress("jets_AK4_n90", &jets_AKPF_n90, &b_jets_AKPF_n90);
    ...
    chainB.SetBranchAddress("jets_AK5PF_status", &jets_AKPF_status, &b_jets_AKPF_status);
    chainB.SetBranchAddress("jets_AK5PF_phi", &jets_AKPF_phi, &b_jets_AKPF_phi);
    chainB.SetBranchAddress("jets_AK5PF_pt", &jets_AKPF_pt, &b_jets_AKPF_pt);
    chainB.SetBranchAddress("jets_AK5PF_pz", &jets_AKPF_pz, &b_jets_AKPF_pz);
    chainB.SetBranchAddress("jets_AK5PF_px", &jets_AKPF_px, &b_jets_AKPF_px);
    chainB.SetBranchAddress("jets_AK5PF_py", &jets_AKPF_py, &b_jets_AKPF_py);
    chainB.SetBranchAddress("jets_AK5PF_eta", &jets_AKPF_eta, &b_jets_AKPF_eta);
    chainB.SetBranchAddress("jets_AK5PF_theta", &jets_AKPF_theta, &b_jets_AKPF_theta);
    chainB.SetBranchAddress("jets_AK5PF_et", &jets_AKPF_et, &b_jets_AKPF_et);
    chainB.SetBranchAddress("jets_AK5PF_energy", &jets_AKPF_energy, &b_jets_AKPF_energy);
    chainB.SetBranchAddress("jets_AK5PF_parton_Id", &jets_AKPF_parton_Id, &b_jets_AKPF_parton_Id);
    chainB.SetBranchAddress("jets_AK5PF_parton_motherId", &jets_AKPF_parton_motherId, &b_jets_AKPF_parton_motherId);
    chainB.SetBranchAddress("jets_AK5PF_parton_pt", &jets_AKPF_parton_pt, &b_jets_AKPF_parton_pt);
    chainB.SetBranchAddress("jets_AK5PF_parton_phi", &jets_AKPF_parton_phi, &b_jets_AKPF_parton_phi);
    chainB.SetBranchAddress("jets_AK5PF_parton_eta", &jets_AKPF_parton_eta, &b_jets_AKPF_parton_eta);
    chainB.SetBranchAddress("jets_AK5PF_parton_Energy", &jets_AKPF_parton_Energy, &b_jets_AKPF_parton_Energy);
    chainB.SetBranchAddress("jets_AK5PF_parton_mass", &jets_AKPF_parton_mass, &b_jets_AKPF_parton_mass);
    chainB.SetBranchAddress("jets_AK5PF_gen_et", &jets_AKPF_gen_et, &b_jets_AKPF_gen_et);
    chainB.SetBranchAddress("jets_AK5PF_gen_pt", &jets_AKPF_gen_pt, &b_jets_AKPF_gen_pt);
    chainB.SetBranchAddress("jets_AK5PF_gen_eta", &jets_AKPF_gen_eta, &b_jets_AKPF_gen_eta);
    chainB.SetBranchAddress("jets_AK5PF_gen_phi", &jets_AKPF_gen_phi, &b_jets_AKPF_gen_phi);
    chainB.SetBranchAddress("jets_AK5PF_gen_mass", &jets_AKPF_gen_mass, &b_jets_AKPF_gen_mass);
    chainB.SetBranchAddress("jets_AK5PF_gen_Energy", &jets_AKPF_gen_Energy, &b_jets_AKPF_gen_Energy);
    chainB.SetBranchAddress("jets_AK5PF_gen_Id", &jets_AKPF_gen_Id, &b_jets_AKPF_gen_Id);
    ...
    chainB.SetBranchAddress("jets_AK5PF_chgHadE", &jets_AKPF_chgHadE, &b_jets_AKPF_chgHadE);
    chainB.SetBranchAddress("jets_AK5PF_photonEnergy", &jets_AKPF_photonEnergy, &b_jets_AKPF_photonEnergy);
    chainB.SetBranchAddress("jets_AK5PF_chgMuE", &jets_AKPF_chgMuE, &b_jets_AKPF_chgMuE);
    chainB.SetBranchAddress("jets_AK5PF_chg_Mult", &jets_AKPF_chg_Mult, &b_jets_AKPF_chg_Mult);
    chainB.SetBranchAddress("jets_AK5PF_neutralEmE", &jets_AKPF_neutralEmE, &b_jets_AKPF_neutralEmE);
    chainB.SetBranchAddress("jets_AK5PF_neutralHadE", &jets_AKPF_neutralHadE, &b_jets_AKPF_neutralHadE);
    chainB.SetBranchAddress("jets_AK5PF_neutral_Mult", &jets_AKPF_neutral_Mult, &b_jets_AKPF_neutral_Mult);
    chainB.SetBranchAddress("jets_AK5PF_mu_Mult", &jets_AKPF_mu_Mult, &b_jets_AKPF_mu_Mult);
    chainB.SetBranchAddress("jets_AK5PF_emf", &jets_AKPF_emf, &b_jets_AKPF_emf);
    chainB.SetBranchAddress("jets_AK5PF_ehf", &jets_AKPF_ehf, &b_jets_AKPF_ehf);
    chainB.SetBranchAddress("jets_AK5PF_n60", &jets_AKPF_n60, &b_jets_AKPF_n60);
    chainB.SetBranchAddress("jets_AK5PF_n90", &jets_AKPF_n90, &b_jets_AKPF_n90);
    chainB.SetBranchAddress("jets_AK5PF_etaetaMoment", &jets_AKPF_etaetaMoment, &b_jets_AKPF_etaetaMoment);
    chainB.SetBranchAddress("jets_AK5PF_etaphiMoment", &jets_AKPF_etaphiMoment, &b_jets_AKPF_etaphiMoment);
    chainB.SetBranchAddress("jets_AK5PF_phiphiMoment", &jets_AKPF_phiphiMoment, &b_jets_AKPF_phiphiMoment);
    chainB.SetBranchAddress("jets_AK5PF_n90Hits", &jets_AKPF_n90Hits, &b_jets_AKPF_n90Hits);
    chainB.SetBranchAddress("jets_AK5PF_fHPD", &jets_AKPF_fHPD, &b_jets_AKPF_fHPD);
    chainB.SetBranchAddress("jets_AK5PF_fRBX", &jets_AKPF_fRBX, &b_jets_AKPF_fRBX);
    chainB.SetBranchAddress("jets_AK5PF_hitsInN90", &jets_AKPF_hitsInN90, &b_jets_AKPF_hitsInN90);
    chainB.SetBranchAddress("jets_AK5PF_nECALTowers", &jets_AKPF_nECALTowers, &b_jets_AKPF_nECALTowers);
    chainB.SetBranchAddress("jets_AK5PF_nHCALTowers", &jets_AKPF_nHCALTowers, &b_jets_AKPF_nHCALTowers);
    chainB.SetBranchAddress("jets_AK5PF_fSubDetector1", &jets_AKPF_fSubDetector1, &b_jets_AKPF_fSubDetector1);
    chainB.SetBranchAddress("jets_AK5PF_fSubDetector2", &jets_AKPF_fSubDetector2, &b_jets_AKPF_fSubDetector2);
    chainB.SetBranchAddress("jets_AK5PF_fSubDetector3", &jets_AKPF_fSubDetector3, &b_jets_AKPF_fSubDetector3);
    chainB.SetBranchAddress("jets_AK5PF_fSubDetector4", &jets_AKPF_fSubDetector4, &b_jets_AKPF_fSubDetector4);
    chainB.SetBranchAddress("jets_AK5PF_area", &jets_AKPF_area, &b_jets_AKPF_area);
    chainB.SetBranchAddress("jets_AK5PF_corrFactorRaw", &jets_AKPF_corrFactorRaw, &b_jets_AKPF_corrFactorRaw);
    chainB.SetBranchAddress("jets_AK5PF_rawPt", &jets_AKPF_rawPt, &b_jets_AKPF_rawPt);
    chainB.SetBranchAddress("jets_AK5PF_mass", &jets_AKPF_mass, &b_jets_AKPF_mass);
  ...
  chainB.SetBranchAddress("mus_numberOfMatchedStations", &mus_numberOfMatchedStations, &b_mus_numberOfMatchedStations);
    ...
    if (cmEnergy<=8) {
      ...
      chainB.SetBranchAddress("Nmets", &Npfmets, &b_Npfmets);
      chainB.SetBranchAddress("mets_et", &pfmets_et, &b_pfmets_et);
      chainB.SetBranchAddress("mets_phi", &pfmets_phi, &b_pfmets_phi);
      chainB.SetBranchAddress("mets_ex", &pfmets_ex, &b_pfmets_ex);
      chainB.SetBranchAddress("mets_ey", &pfmets_ey, &b_pfmets_ey);
      chainB.SetBranchAddress("mets_gen_et", &pfmets_gen_et, &b_pfmets_gen_et);
      chainB.SetBranchAddress("mets_gen_phi", &pfmets_gen_phi, &b_pfmets_gen_phi);
      chainB.SetBranchAddress("mets_sign", &pfmets_sign, &b_pfmets_sign);
      chainB.SetBranchAddress("mets_sumEt", &pfmets_sumEt, &b_pfmets_sumEt);
      chainB.SetBranchAddress("mets_unCPhi", &pfmets_unCPhi, &b_pfmets_unCPhi);
      chainB.SetBranchAddress("mets_unCPt", &pfmets_unCPt, &b_pfmets_unCPt);
    }
