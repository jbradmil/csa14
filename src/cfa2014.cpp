...
void cfA::InitializeB(){
  std::cout << "cmEnergy=" << cmEnergy << std::endl;
  std::cout << "cfAVersion=" << cfAVersion << std::endl;
  ...
  if (cfAVersion<=71||cfAVersion==74) {
    ...
    chainB.SetBranchAddress("mets_phi", &pfTypeImets_phi, &b_pfTypeImets_phi);
    chainB.SetBranchAddress("mets_ex", &pfTypeImets_ex, &b_pfTypeImets_ex);
    chainB.SetBranchAddress("mets_ey", &pfTypeImets_ey, &b_pfTypeImets_ey);
    chainB.SetBranchAddress("mets_gen_et", &pfTypeImets_gen_et, &b_pfTypeImets_gen_et);
