...
class cfA{
protected:
  cfA(const std::string&, const bool);
  ...
  void SetFile(const std::string&, const bool);
  ...
  void GetVersion();
  void GetCMEnergy();
  void AddFiles(const std::string&, const bool);
  ...
  std::vector<float> *taus_CombinedIsolationDeltaBetaCorrRaw3Hits;
  std::vector<bool> *taus_byLooseCombinedIsolationDeltaBetaCorr3Hits;
  std::vector<bool> *taus_byMediumCombinedIsolationDeltaBetaCorr3Hits;
  std::vector<bool> *taus_byTightCombinedIsolationDeltaBetaCorr3Hits;
  std::vector<int> *taus_n_pfcands;
  std::vector<int> *taus_decayMode;
  std::vector<bool> *taus_byDecayModeFinding;
  std::vector<bool> *taus_byDecayModeFindingNewDMs;
  std::vector<float> *taus_chargedIsoPtSum;
  std::vector<float> *taus_neutralIsoPtSum;
  std::vector<float> *taus_puCorrPtSum;
  std::vector<bool> *taus_againstMuonLoose3;
  std::vector<bool> *taus_againstElectronLooseMVA5;
  ...
  TBranch *b_trackercoherentnoisefilter1_decision;
  TBranch *b_trackercoherentnoisefilter2_decision;
  TBranch *b_trackertoomanyclustersfilter_decision;
  TBranch *b_trackertoomanytripletsfilter_decision;
  TBranch *b_trackertoomanyseedsfilter_decision;
  ...
  // One pointer per variable, set to the correct branch,
  // according to cmEnergy
  UInt_t Njets_AKPF;
  std::vector<float> *jets_AKPF_status;
  std::vector<float> *jets_AKPF_phi;
  std::vector<float> *jets_AKPF_pt;
  std::vector<float> *jets_AKPF_pz;
  std::vector<float> *jets_AKPF_px;
  std::vector<float> *jets_AKPF_py;
  std::vector<float> *jets_AKPF_eta;
  std::vector<float> *jets_AKPF_theta;
  std::vector<float> *jets_AKPF_et;
  std::vector<float> *jets_AKPF_energy;
  std::vector<float> *jets_AKPF_parton_Id;
  std::vector<float> *jets_AKPF_parton_motherId;
  std::vector<float> *jets_AKPF_parton_pt;
  std::vector<float> *jets_AKPF_parton_phi;
  std::vector<float> *jets_AKPF_parton_eta;
  std::vector<float> *jets_AKPF_parton_Energy;
  std::vector<float> *jets_AKPF_parton_mass;
  std::vector<float> *jets_AKPF_gen_et;
  std::vector<float> *jets_AKPF_gen_pt;
  std::vector<float> *jets_AKPF_gen_eta;
  std::vector<float> *jets_AKPF_gen_phi;
  std::vector<float> *jets_AKPF_gen_mass;
  std::vector<float> *jets_AKPF_gen_Energy;
  std::vector<float> *jets_AKPF_gen_Id;
  std::vector<float> *jets_AKPF_gen_motherID;
  std::vector<float> *jets_AKPF_gen_threeCharge;
  std::vector<float> *jets_AKPF_partonFlavour;
  std::vector<float> *jets_AKPF_btag_TC_highPur;
  std::vector<float> *jets_AKPF_btag_TC_highEff;
  std::vector<float> *jets_AKPF_btag_jetProb;
  std::vector<float> *jets_AKPF_btag_jetBProb;
  std::vector<float> *jets_AKPF_btag_softEle;
  std::vector<float> *jets_AKPF_btag_softMuon;
  std::vector<float> *jets_AKPF_btag_secVertexHighPur;
  std::vector<float> *jets_AKPF_btag_secVertexHighEff;
  std::vector<float> *jets_AKPF_btag_secVertexCombined;
  std::vector<float> *jets_AKPF_btag_inc_secVertexCombined;
  std::vector<float> *jets_AKPF_btag_pf_secVertexCombined;
  std::vector<float> *jets_AKPF_btag_MVA;
  std::vector<float> *jets_AKPF_jetCharge;
  std::vector<float> *jets_AKPF_chgEmE;
  std::vector<float> *jets_AKPF_chgHadE;
  std::vector<float> *jets_AKPF_photonEnergy;
  std::vector<float> *jets_AKPF_chgMuE;
  std::vector<float> *jets_AKPF_chg_Mult;
  std::vector<float> *jets_AKPF_neutralEmE;
  std::vector<float> *jets_AKPF_neutralHadE;
  std::vector<float> *jets_AKPF_neutral_Mult;
  std::vector<float> *jets_AKPF_mu_Mult;
  std::vector<float> *jets_AKPF_emf;
  std::vector<float> *jets_AKPF_ehf;
  std::vector<float> *jets_AKPF_n60;
  std::vector<float> *jets_AKPF_n90;
  std::vector<float> *jets_AKPF_etaetaMoment;
  std::vector<float> *jets_AKPF_etaphiMoment;
  std::vector<float> *jets_AKPF_phiphiMoment;
  std::vector<float> *jets_AKPF_n90Hits;
  std::vector<float> *jets_AKPF_fHPD;
  std::vector<float> *jets_AKPF_fRBX;
  std::vector<float> *jets_AKPF_hitsInN90;
  std::vector<float> *jets_AKPF_nECALTowers;
  std::vector<float> *jets_AKPF_nHCALTowers;
  std::vector<float> *jets_AKPF_fSubDetector1;
  std::vector<float> *jets_AKPF_fSubDetector2;
  std::vector<float> *jets_AKPF_fSubDetector3;
  std::vector<float> *jets_AKPF_fSubDetector4;
  std::vector<float> *jets_AKPF_area;
  std::vector<float> *jets_AKPF_corrFactorRaw;
  std::vector<float> *jets_AKPF_rawPt;
  std::vector<float> *jets_AKPF_mass;
  ...
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT10_px;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT10_py;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT10_pz;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT10_energy;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT10_phi;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT10_eta;
  std::vector<std::vector<int> > *fastjets_AKPF_R1p2_R0p5pT10_index;
  std::vector<int>     *fastjets_AKPF_R1p2_R0p5pT10_nconstituents;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT15_px;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT15_py;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT15_pz;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT15_energy;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT15_phi;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT15_eta;
  std::vector<std::vector<int> > *fastjets_AKPF_R1p2_R0p5pT15_index;
  std::vector<int>     *fastjets_AKPF_R1p2_R0p5pT15_nconstituents;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT20_px;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT20_py;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT20_pz;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT20_energy;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT20_phi;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT20_eta;
  std::vector<std::vector<int> > *fastjets_AKPF_R1p2_R0p5pT20_index;
  std::vector<int>     *fastjets_AKPF_R1p2_R0p5pT20_nconstituents;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT25_px;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT25_py;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT25_pz;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT25_energy;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT25_phi;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT25_eta;
  std::vector<std::vector<int> > *fastjets_AKPF_R1p2_R0p5pT25_index;
  std::vector<int>     *fastjets_AKPF_R1p2_R0p5pT25_nconstituents;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT30_px;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT30_py;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT30_pz;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT30_energy;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT30_phi;
  std::vector<float>   *fastjets_AKPF_R1p2_R0p5pT30_eta;
  std::vector<std::vector<int> > *fastjets_AKPF_R1p2_R0p5pT30_index;
  std::vector<int>     *fastjets_AKPF_R1p2_R0p5pT30_nconstituents;
  ...
  TBranch *b_Njets_AKPF;
  TBranch *b_jets_AKPF_status;
  TBranch *b_jets_AKPF_phi;
  TBranch *b_jets_AKPF_pt;
  TBranch *b_jets_AKPF_pz;
  TBranch *b_jets_AKPF_px;
  TBranch *b_jets_AKPF_py;
  TBranch *b_jets_AKPF_eta;
  TBranch *b_jets_AKPF_theta;
  TBranch *b_jets_AKPF_et;
  TBranch *b_jets_AKPF_energy;
  TBranch *b_jets_AKPF_parton_Id;
  TBranch *b_jets_AKPF_parton_motherId;
  TBranch *b_jets_AKPF_parton_pt;
  TBranch *b_jets_AKPF_parton_phi;
  TBranch *b_jets_AKPF_parton_eta;
  TBranch *b_jets_AKPF_parton_Energy;
  TBranch *b_jets_AKPF_parton_mass;
  TBranch *b_jets_AKPF_gen_et;
  TBranch *b_jets_AKPF_gen_pt;
  TBranch *b_jets_AKPF_gen_eta;
  TBranch *b_jets_AKPF_gen_phi;
  TBranch *b_jets_AKPF_gen_mass;
  TBranch *b_jets_AKPF_gen_Energy;
  TBranch *b_jets_AKPF_gen_Id;
  TBranch *b_jets_AKPF_gen_motherID;
  TBranch *b_jets_AKPF_gen_threeCharge;
  TBranch *b_jets_AKPF_partonFlavour;
  TBranch *b_jets_AKPF_btag_TC_highPur;
  TBranch *b_jets_AKPF_btag_TC_highEff;
  TBranch *b_jets_AKPF_btag_jetProb;
  TBranch *b_jets_AKPF_btag_jetBProb;
  TBranch *b_jets_AKPF_btag_softEle;
  TBranch *b_jets_AKPF_btag_softMuon;
  TBranch *b_jets_AKPF_btag_secVertexHighPur;
  TBranch *b_jets_AKPF_btag_secVertexHighEff;
  TBranch *b_jets_AKPF_btag_secVertexCombined;
  TBranch *b_jets_AKPF_btag_inc_secVertexCombined;
  TBranch *b_jets_AKPF_btag_pf_secVertexCombined;
  TBranch *b_jets_AKPF_btag_MVA;
  TBranch *b_jets_AKPF_jetCharge;
  TBranch *b_jets_AKPF_chgEmE;
  TBranch *b_jets_AKPF_chgHadE;
  TBranch *b_jets_AKPF_photonEnergy;
  TBranch *b_jets_AKPF_chgMuE;
  TBranch *b_jets_AKPF_chg_Mult;
  TBranch *b_jets_AKPF_neutralEmE;
  TBranch *b_jets_AKPF_neutralHadE;
  TBranch *b_jets_AKPF_neutral_Mult;
  TBranch *b_jets_AKPF_mu_Mult;
  TBranch *b_jets_AKPF_emf;
  TBranch *b_jets_AKPF_ehf;
  TBranch *b_jets_AKPF_n60;
  TBranch *b_jets_AKPF_n90;
  TBranch *b_jets_AKPF_etaetaMoment;
  TBranch *b_jets_AKPF_etaphiMoment;
  TBranch *b_jets_AKPF_phiphiMoment;
  TBranch *b_jets_AKPF_n90Hits;
  TBranch *b_jets_AKPF_fHPD;
  TBranch *b_jets_AKPF_fRBX;
  TBranch *b_jets_AKPF_hitsInN90;
  TBranch *b_jets_AKPF_nECALTowers;
  TBranch *b_jets_AKPF_nHCALTowers;
  TBranch *b_jets_AKPF_fSubDetector1;
  TBranch *b_jets_AKPF_fSubDetector2;
  TBranch *b_jets_AKPF_fSubDetector3;
  TBranch *b_jets_AKPF_fSubDetector4;
  TBranch *b_jets_AKPF_area;
  TBranch *b_jets_AKPF_corrFactorRaw;
  TBranch *b_jets_AKPF_rawPt;
  TBranch *b_jets_AKPF_mass;
  ...
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_px;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_py;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_pz;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_energy;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_phi;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_eta;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_index;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT10_nconstituents;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_px;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_py;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_pz;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_energy;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_phi;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_eta;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_index;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT15_nconstituents;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_px;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_py;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_pz;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_energy;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_phi;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_eta;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_index;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT20_nconstituents;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_px;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_py;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_pz;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_energy;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_phi;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_eta;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_index;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT25_nconstituents;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_px;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_py;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_pz;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_energy;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_phi;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_eta;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_index;   //!
  TBranch        *b_fastjets_AKPF_R1p2_R0p5pT30_nconstituents;   //!
};
