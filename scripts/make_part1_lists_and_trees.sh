...
echo "ls -d $CFADIR/$DATASET/*f1_*.root > $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part10.list"
ls -d $CFADIR/$DATASET/*f1_*.root > $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part10.list
...
JobSubmit.csh ./scripts/make_reduced_tree.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part10.list
...
do
    ...
    JobSubmit.csh ./scripts/make_reduced_tree.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part1$i.list
