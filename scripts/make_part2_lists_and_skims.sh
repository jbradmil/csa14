...
echo "[DEBUG] JobSubmit.csh ./scripts/skim_file.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part20.list"  
JobSubmit.csh ./scripts/skim_file.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part20.list
...
do
    ...
    echo "[DEBUG] JobSubmit.csh ./scripts/skim_file.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part2$i.list"  
    JobSubmit.csh ./scripts/skim_file.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part2$i.list
