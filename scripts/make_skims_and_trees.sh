...
do
    ...
    echo "[DEBUG] JobSubmit.csh ./scripts/skim_file.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part$i.list"  
    JobSubmit.csh ./scripts/skim_file.exe -l -i $OUTPUTDIR/$ENERGY/$DATASET/$DATASET.part$i.list
