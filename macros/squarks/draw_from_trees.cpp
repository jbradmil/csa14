...
TChain* other_ch;
TChain* t2tt_850_100_ch;
TChain* t2tt_650_325_ch;
TChain* t2tt_500_325_ch;
TChain* t2tt_425_325_ch;
		     ...
		     TString plot_title="default")
{
  ...
  TH1D * ht2tt_500_325 = new TH1D("t2tt_500_325" , title, nbinsx, xlow, xup);
  TH1D * ht2tt_425_325 = new TH1D("t2tt_425_325" , title, nbinsx, xlow, xup);
  TH1D * ht2tt_850_100 = new TH1D("t2tt_850_100" , title, nbinsx, xlow, xup);
  TH1D * ht2tt_650_325 = new TH1D("t2tt_650_325" , title, nbinsx, xlow, xup);
 ...
 t2tt_500_325_ch->Project("t2tt_500_325",var,(cut)*weights);
  t2tt_425_325_ch->Project("t2tt_425_325",var,(cut)*weights);
  t2tt_850_100_ch->Project("t2tt_850_100",var,(cut)*weights);
  t2tt_650_325_ch->Project("t2tt_650_325",var,(cut)*weights);
  ...
  if (addOverflow) {
    ...
    i_overflow=ht2tt_500_325->IntegralAndError(nbinsx,nbinsx+1,e_overflow);
    ht2tt_500_325->SetBinContent(nbinsx, i_overflow);
    ht2tt_500_325->SetBinError(nbinsx, e_overflow);
    i_overflow=ht2tt_425_325->IntegralAndError(nbinsx,nbinsx+1,e_overflow);
    ht2tt_425_325->SetBinContent(nbinsx, i_overflow);
    ht2tt_425_325->SetBinError(nbinsx, e_overflow);
    i_overflow=ht2tt_850_100->IntegralAndError(nbinsx,nbinsx+1,e_overflow);
    ht2tt_850_100->SetBinContent(nbinsx, i_overflow);
    ht2tt_850_100->SetBinError(nbinsx, e_overflow);
    i_overflow=ht2tt_650_325->IntegralAndError(nbinsx,nbinsx+1,e_overflow);
    ht2tt_650_325->SetBinContent(nbinsx, i_overflow);
    ht2tt_650_325->SetBinError(nbinsx, e_overflow);
  }
  ...
  Double_t ttbar_e(0.), qcd_e(0.), znn_e(0.), wjets_e(0.), other_e(0.), single_top_e(0.), bg_tot_e(0.), t2tt_850_100_e(0.);
  ...
  double t2tt_850_100_n(ht2tt_850_100->IntegralAndError(0,nbinsx+1, t2tt_850_100_e));


  printf("Counts before cut: %s\n",var.Data());
  printf("&ttbar&qcd&znn&wjets&single top&other&t2tt_500_325\\\\ \n");
  ...
  if (sigStack) {
    for (int bin(0); bin<nbinsx; bin++) {
      ht2tt_500_325->SetBinContent(bin+1, hmc_exp->GetBinContent(bin+1));
      ht2tt_425_325->SetBinContent(bin+1, hmc_exp->GetBinContent(bin+1));
      ht2tt_850_100->SetBinContent(bin+1, hmc_exp->GetBinContent(bin+1));
      ht2tt_650_325->SetBinContent(bin+1, hmc_exp->GetBinContent(bin+1));
    }
  }
  ...
  if (plotSig) {
    leg1->AddEntry(ht2tt_850_100, "#splitline{T2tt}{(850,100) GeV}", "l");
    leg1->AddEntry(ht2tt_650_325, "#splitline{T2tt}{(650,325) GeV}", "l");
    leg1->AddEntry(ht2tt_500_325, "#splitline{T2tt}{(500,325) GeV}", "l");
    leg1->AddEntry(ht2tt_425_325, "#splitline{T2tt}{(425,325) GeV}", "l");
  }
  ...
  if (ht2tt_850_100->GetMaximum()>ymax) ymax=ht2tt_850_100->GetMaximum();
  if (ht2tt_500_325->GetMaximum()>ymax) ymax=ht2tt_500_325->GetMaximum();
  ...
  if (plotSig) {
    ht2tt_500_325->SetLineColor(2);
    ht2tt_500_325->SetLineWidth(4);
    ht2tt_500_325->SetFillColor(0);
    ht2tt_425_325->SetLineColor(2);
    ht2tt_425_325->SetLineWidth(4);
    ht2tt_425_325->SetLineStyle(7);
    ht2tt_425_325->SetFillColor(0);
    ht2tt_850_100->SetLineColor(kGreen);
    ht2tt_850_100->SetLineWidth(4);
    ht2tt_850_100->SetFillColor(0);
    ht2tt_650_325->SetLineColor(kGreen);
    ht2tt_650_325->SetLineStyle(7);
    ht2tt_650_325->SetLineWidth(4);
    ht2tt_650_325->SetFillColor(0);
    ht2tt_500_325->Draw("hist same");
    ht2tt_425_325->Draw("hist same");
    ht2tt_850_100->Draw("hist same");
    ht2tt_650_325->Draw("hist same");
  }
  ...
  delete ht2tt_500_325;
  delete ht2tt_425_325;
  delete ht2tt_850_100;
  delete ht2tt_650_325;
...
int main() {
  ...
  t2tt_850_100_ch = new TChain("reduced_tree");
  t2tt_650_325_ch = new TChain("reduced_tree");
 t2tt_500_325_ch = new TChain("reduced_tree");
  t2tt_425_325_ch = new TChain("reduced_tree");

  
  TFileCollection* ttbar_fc = new TFileCollection("ttbar_fc","","../../save/tfcs/ttbar.txt");
  ...
  t2tt_850_100_ch->Add("../../reduced_trees/SMS-T2tt_2J_mStop-850_mLSP-100_Tune4C_13TeV-madgraph-tauola_Spring14miniaod-PU20bx25_PLS170_V7AN1-v1_MINIAODSIM_UCSB2281_v76/*.root");
  t2tt_650_325_ch->Add("../../reduced_trees/SMS-T2tt_2J_mStop-650_mLSP-325_Tune4C_13TeV-madgraph-tauola_Spring14miniaod-PU20bx25_POSTLS170_V5-v1_MINIAODSIM_UCSB2284_v75/*.root");
  t2tt_500_325_ch->Add("../../reduced_trees/SMS-T2tt_2J_mStop-500_mLSP-325_Tune4C_13TeV-madgraph-tauola_Spring14miniaod-PU20bx25_POSTLS170_V5-v1_MINIAODSIM_UCSB2283_v75/*.root");
  t2tt_425_325_ch->Add("../../reduced_trees/SMS-T2tt_2J_mStop-425_mLSP-325_Tune4C_13TeV-madgraph-tauola_Spring14miniaod-PU20bx25_POSTLS170_V5-v1_MINIAODSIM_UCSB2282_v75/*.root");

  cout << "Entries in chains..." << endl;
  cout << "t2tt_850_100 N=" << t2tt_850_100_ch->GetEntries() << endl;
  cout << "t2tt_650_325 N=" << t2tt_650_325_ch->GetEntries() << endl;
  cout << "t2tt_500_325 N=" << t2tt_500_325_ch->GetEntries() << endl;
  cout << "t2tt_425_325 N=" << t2tt_425_325_ch->GetEntries() << endl;
  ...
  */
  ...
  // min_mT
  draw_from_trees("min_mTWB","met>200&&met<400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=2&&num_jets_pt30<=3&&num_csvm_jets30>1&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:plotLog",-1,-1,
    		  "min_mTWB_modmet_1202_2_3j");
  draw_from_trees("min_mTWB","met>200&&met<400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=4&&num_jets_pt30<=6&&num_csvm_jets30>1&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:plotLog",-1,-1,
    		  "min_mTWB_modmet_1202_4_6j");
  draw_from_trees("min_mTWB","met>200&&met<400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=7&&num_jets_pt30<=9&&num_csvm_jets30>1&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:plotLog",-1,-1,
    		  "min_mTWB_modmet_1202_7_9j");
  draw_from_trees("min_mTWB","met>200&&met<400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=10&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:plotLog",-1,-1,
    		  "min_mTWB_modmet_1202_geq10j");
  draw_from_trees("min_mTWB","met>400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=2&&num_jets_pt30<=3&&num_csvm_jets30>1&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:plotLog",-1,-1,
    		  "min_mTWB_1202_2_3j");
  draw_from_trees("min_mTWB","met>400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=4&&num_jets_pt30<=6&&num_csvm_jets30>1&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:plotLog",-1,-1,
    		  "min_mTWB_1202_4_6j");
  draw_from_trees("min_mTWB","met>400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=7&&num_jets_pt30<=9&&num_csvm_jets30>1&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:",-1,-1,
    		  "min_mTWB_1202_7_9j");
  draw_from_trees("min_mTWB","met>400&&num_reco_veto_muons+num_reco_veto_electrons==0&&num_jets_pt30>=10&&min_delta_phi_met_N>4","(weightppb*5000)",
    		  ";m_{T}^{min} (b, MET) [GeV];Events / 20 fb^{-1}", 20, 0., 500.,
   		  "plotSig:",-1,-1,
    		  "min_mTWB_1202_geq10j");
  ...
  draw_from_trees("min_delta_phi_met_N","met>400&&ht30>500&&num_reco_veto_muons==0&&num_reco_veto_electrons==0&&num_jets_pt30>=4&&num_csvm_jets30>=2","(weightppb*5000)",
   		  ...
   		  "plotSig:plotLog",-1,-1,
    		  "min_delta_phi_met_N_nm1_1202_v2");
  draw_from_trees("num_reco_veto_electrons+num_reco_veto_muons","met>400&&ht30>500&&num_jets_pt30>=4&&min_delta_phi_met_N>4&&num_csvm_jets30>=2","(weightppb*5000)",
		  ...
		  "plotSig:plotLog",-1,-1,
		  "num_reco_veto_lepton_nm1_1202_v2");
  ...
  draw_from_trees("fatpT30_MJ","met>200&&num_csvm_jets30>1&&min_delta_phi_met_N>4&&num_reco_veto_muons==0&&num_reco_veto_electrons==0&&num_jets_pt30>=4","(weightppb*5000)",
  		  ...
  		  "plotSig:plotLog",-1,-1,
  		  "fatpT30_MJ_1202_4j30_met250_nm1");
  ...
  //   		  ";#Delta#Phi^{min}_{N};Events / 20 fb^{-1}", 20, 0., 40,
  //  		  "plotSig:plotLog",-1,-1,
  //   		  "min_delta_phi_met_N_nm1_v2_1202");
