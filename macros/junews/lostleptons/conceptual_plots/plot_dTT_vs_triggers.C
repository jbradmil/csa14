...
void plot_dTT_vs_triggers(const TString treestring = "reduced_trees/13TeV/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola_Phys14DR-PU20bx25_PHYS14_25_V1-v1_MINIAODSIM_UCSB2406_v78/*.root", const TString plotNote="ttbar_1mu", bool logy = true) {
  ...
  TH1D* hAll = new TH1D("hAll", ";#frac{1}{2}(1-cos#Delta#theta_{T});Fraction of all 1-e/#mu events", 20, 0, 1);
  TH1D* hHT350MET120 = new TH1D("hHT350MET120", ";#frac{1}{2}(1-cos#Delta#theta_{T});Fraction of all 1-e/#mu events", 20, 0, 1);
  TH1D* hHT900 = new TH1D("hHT900", ";#frac{1}{2}(1-cos#Delta#theta_{T});Fraction of all 1-e/#mu events", 20, 0, 1);
  TH1D* hL15HT600 = new TH1D("hL15HT600", ";#frac{1}{2}(1-cos#Delta#theta_{T});Fraction of all 1-e/#mu events", 20, 0, 1);
  TH1D* hL15HT400MET70 = new TH1D("hL15HT400MET70", ";#frac{1}{2}(1-cos#Delta#theta_{T});Fraction of all 1-e/#mu events", 20, 0, 1);
  hAll->SetLineWidth(3);
  hAll->SetLineStyle(1);
  hAll->SetLineColor(1);
  ...
  pypu->Project("hAll", "(1/2)*(1-cos(true_mu_dTT))", (SL+baseline+"true_mu_pt>0")*weight);
  pypu->Project("hHT350MET120", "(1/2)*(1-cos(mu_dTT))", (SL+baseline+"mu_pt>10&&ht30>500&&mht30>200")*weight);
  pypu->Project("hHT900", "(1/2)*(1-cos(mu_dTT))", (SL+baseline+"mu_pt>10&&ht30>1000")*weight);
  pypu->Project("hL15HT600", "(1/2)*(1-cos(mu_dTT))", (SL+baseline+"mu_pt>20&&ht30>750")*weight);
  pypu->Project("hL15HT400MET70", "(1/2)*(1-cos(mu_dTT))", (SL+baseline+"mu_pt>20&&ht30>550&&mht30>125")*weight);
  ...
  double norm = hAll->Integral(1, 21);
  hAll->Scale(1/norm);
  ...
  c1->Print("macros/junews/lostleptons/conceptual_plots/dTT_vs_triggers.pdf");
