...
void compare_emu_tau_dTT_noStack(const TString treestring = "reduced_trees/13TeV/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola_Phys14DR-PU20bx25_PHYS14_25_V1-v1_MINIAODSIM_UCSB2406_v78/*.root", const TString plotNote="ttbar_2b", bool logy = false) {
  ...
  c1->Print("macros/junews/lostleptons/conceptual_plots/compare_emu_tau_dTT_noStack.pdf");
