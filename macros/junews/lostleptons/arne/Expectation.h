...
// Wed May 27 08:20:03 2015 by ROOT version 5.34/25
...
const double minDeltaPhiN_=6.0;
...
class Expectation : public TSelector {
 public :
  ...
  /* TBranch        *b_ElDiLepControlSample;   //! */
  /* TBranch        *b_LLMTW;   //! */
  /* TBranch        *b_Bin;   //! */
