...
// Tue May 26 08:10:54 2015 by ROOT version 5.34/25
...
const unsigned int elActivityMethod_=0;               // ###############
...
class Prediction : public TSelector {
 public :
  ...
  double getEff(TH2D* effTH2D, double xValue, double yValue);
  double getEff(TH1D* effTH2D, double xValue);
  // output variables
  TTree *tPrediction_;
  ...
  Float_t muTotalWeight_, muTotalWeightData_, totalMuons_;
  ...
  Float_t elecTotalWeight_, elecTotalWeightData_, totalElectrons_;
  Float_t muDiLepEffMTWAppliedEff_, elecDiLepEffMTWAppliedEff_;
  Float_t expectationReductionIsoTrackEff_;
  Float_t totalWeight_, totalWeightDiLep_, totalWeightDiLepAvg_, totalWeightDiLepIsoTrackReduced_;
  ...
  // Effiecineices
  //    TH2D *MuMTWPTActivity_;
  TH1D *MuMTWNJets_;
  TH1D *MuDiLepContributionMTWAppliedNJets_;
  TH2D *MuIsoPTActivity_, *MuIsoPTActivityTAPMC_;
  //    TH1D *MuRecoActivitiy_;
  TH2D *MuRecoPTActivity_, *MuRecoPTActivityTAPMC_;
  //    TH2D *MuAccHTNJets_;
  // 	 TH2D *MuAccBTagNJets_;
  TH2D *MuAccMHTNJets_;
  TH1D *MuDiLepEffMTWAppliedNJets_;
  TH2D *MuPurityMHTNJets_;
   
  TH2D *ElecIsoPTActivity_, *ElecIsoPTActivityTAPMC_;
  //    TH1D *ElecRecoActivity_;
  TH2D *ElecRecoPTActivity_, *ElecRecoPTActivityTAPMC_;
  //    TH2D *ElecAccHTNJets_;
  // 	 TH2D *ElecAccBTagNJets_;
  TH2D *ElecAccMHTNJets_;
  TH2D *ElecPurityMHTNJets_;
  // 	 TH2D *ElecMTWPTActivity_;
  TH1D *ElecMTWNJets_;
  TH1D *ElecDiLepContributionMTWAppliedNJets_;
  TH1D *ElecDiLepEffMTWAppliedNJets_;
	 
  UShort_t elActivityMethod, muActivityMethod;
  // TEfficiency objects
...
void Prediction::Init(TTree *tree)
{
  ...
  /* fChain->SetBranchAddress("elAcc", &elAcc, &b_elAcc); */
  /* fChain->SetBranchAddress("elMTW", &elMTW, &b_elMTW); */
  /* fChain->SetBranchAddress("elecTotal", &elecTotal, &b_elecTotal); */
  /* fChain->SetBranchAddress("MuPurity", &MuPurity, &b_MuPurity); */
  /* fChain->SetBranchAddress("ElPurity", &ElPurity, &b_ElPurity); */
  ...
  /* fChain->SetBranchAddress("ElDiLepControlSample", &ElDiLepControlSample, &b_ElDiLepControlSample); */
