...
#ifndef FillInputHists_h
#define FillInputHists_h
...
public :
   ...
   FillInputHists(TTree *tree=0);
   virtual ~FillInputHists();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Run(TString outfiletag="default");
...
#ifdef FillInputHists_cxx
FillInputHists::FillInputHists(TTree *tree) : fChain(0) 
{
...
FillInputHists::~FillInputHists()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FillInputHists::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FillInputHists::LoadTree(Long64_t entry)
{
...
void FillInputHists::Init(TTree *tree)
{
...
void FillInputHists::Show(Long64_t entry)
{
...
Int_t FillInputHists::Cut(Long64_t entry)
{
...
#endif // #ifdef FillInputHists_cxx
