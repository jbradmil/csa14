...
TH1D* GetEPredHist(TString hname, TH1D* hPred, TH1D* hRatio, int ratio1_ind, int ratio2_ind=-1, int ratio3_ind=-1) {
  ...
  double cpred1 = hPred->IntegralAndError(1, 2, cerr1);
  double cpred2 = hPred->IntegralAndError(3, 3, cerr2);
  double cpred3 = hPred->IntegralAndError(2, 3, cerr3);
 		    ...
 		    TString ratiofile="outputfiles/analysis-output3-default.root")
{
  ...
  TH1D* hEPredNB2NJ1 = GetEPredHist("hEPredNB2NJ1", hCPredNB2NJ1, hratios, 3, 7, 10);
  TH1D* hEPredNB2NJ2 = GetEPredHist("hEPredNB2NJ2", hCPredNB2NJ2, hratios, 4, 8, 10);
  TH1D* hEPredNB2NJ3 = GetEPredHist("hEPredNB2NJ3", hCPredNB2NJ3, hratios, 4, 8, 10);
  TH1D* hEPredNB3NJ1 = GetEPredHist("hEPredNB3NJ1", hCPredNB3NJ1, hratios, 3, 7, 10);
