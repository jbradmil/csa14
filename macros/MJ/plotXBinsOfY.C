...
void plotXBinsOfY(const TString xvar = "MJ_pt100", int nbinsx = 50, double xlow=0., double xhigh=1500., const TString yvar = "num_primary_vertices", TString xAxisTitle="M_{J} [GeV]", TString yLegLabel = "NPV", const TString treestring = "reduced_trees/TTJets*v75*.root", const TString plotNote="ttbar", const TCut xtraCuts="", bool logy = false) 
{ 
  ...
  thecanvas->Print("macros/MJ/plots/talk1013/"+xvar+"_vs_"+yvar+"_"+plotNote+"_slices.pdf");
