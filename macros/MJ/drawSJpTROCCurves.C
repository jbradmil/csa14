...
void drawSJpTROCCurves(const TString sigName = "reduced_trees/SMS-T1tttt_2J_mGl-1500_mLSP-100*v75*.root", const TString bgName = "all", const TString plotNote="T1tttt_1500_100_allBG", const unsigned int nbins=20, const TCut cuts="", const bool killHighWeights=false) 
{
  set_plot_style();
  ...
  TH1D* hSJ_pT10sig = new TH1D("hSJ_pT10sig","",nbins,0.,1500.);
  TH1D* hSJ_pT10bg = new TH1D("hSJ_pT10bg","",nbins,0.,1500.);
  TH1D* hSJ_pT20sig = new TH1D("hSJ_pT20sig","",nbins,0.,1500.);
  TH1D* hSJ_pT20bg = new TH1D("hSJ_pT20bg","",nbins,0.,1500.);
  TH1D* hSJ_pT30sig = new TH1D("hSJ_pT30sig","",nbins,0.,1500.);
  TH1D* hSJ_pT30bg = new TH1D("hSJ_pT30bg","",nbins,0.,1500.);
  ...
  sig->Project("hSJ_pT10sig","fatpT10_MJ",weighted_selection);
  bg->Project("hSJ_pT10bg","fatpT10_MJ",weighted_selection);
  sig->Project("hSJ_pT20sig","fatpT20_MJ",weighted_selection);
  bg->Project("hSJ_pT20bg","fatpT20_MJ",weighted_selection);
  sig->Project("hSJ_pT30sig","fatpT30_MJ",weighted_selection);
  bg->Project("hSJ_pT30bg","fatpT30_MJ",weighted_selection);
