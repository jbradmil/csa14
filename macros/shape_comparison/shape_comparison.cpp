...
int main() {
  ...
  TCut trigger("passesPVCut&&((ht40>350&&met>120)||(ht40>900)||(met>170)||( (jet1_csv>=0.7||jet2_csv>=0.7||jet3_csv>=0.7||jet4_csv>=0.7||jet5_csv>=0.7||jet6_csv>=0.7)&&met>120))");
  TCut highMass(trigger+"ht50>1000.&&met>200.&&num_csvm_jets>0");
  ...
  */
  ...
  //   		  "plotSig",-1,-1,
  //   		  "ncsvt50");
  //   draw_from_trees("num_csvl_jets20","","(weightppb*20000)",
  //   		  ";n_{CSVL} (p_{T} > 20 GeV);Events / 20 fb^{-1}", 13, 0., 13.,
  //   		  "plotSig",-1,-1,
  //   		  "ncsvl20");
  //  draw_from_trees("num_csvm_jets20","","(weightppb*20000)",
  //   		  ";n_{CSVM} (p_{T} > 20 GeV);Events / 20 fb^{-1}", 13, 0., 13.,
  //   		  "plotSig",-1,-1,
  //   		  "ncsvm20");
  //  draw_from_trees("num_csvt_jets20","","(weightppb*20000)",
  ...
  // 		 "",0.244,0.679,
  // 		 "4th_csv");
  // draw_from_trees("m_eff20","","(weightppb*20000)",
  // 		 ";M_{eff} [GeV];Events / 20 fb^{-1}", 75, 0., 7500.,
  // 		 "",-1,-1,
  // 		 "m_eff20");
  // draw_from_trees("m_eff50","","(weightppb*20000)",
  // 		 ";M_{eff} [GeV];Events / 20 fb^{-1}", 75, 0., 7500.,
  // 		 "",-1,-1,
  // 		 "m_eff50");
  // draw_from_trees("m_eff20","","(weightppb*20000)",
