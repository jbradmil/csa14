...
void compare_phys14(TString var, TString xtitle, int nbinsx, float low, float high, bool T2tt=true, TCut cuts="", TString comments="", double forceMax=-1., bool logscale=false) {
  ...
  if (T2tt) {
    chain7_0_50->Add("reduced_trees/SMS-T2tt_13TeV_50ns_v73/*.root");
    chain7_0_25->Add("reduced_trees/SMS-T2tt_2J_mStop-850_mLSP-100_Tune4C_13TeV-madgraph-tauola_Spring14miniaod-PU20bx25_PLS170_V7AN1-v1_MINIAODSIM_UCSB2281_v76/*.root");
    chain7_2_25->Add("reduced_trees/SMS-T2tt_13TeV_PHYS14_v73/*.root");
  } else {
  ...
  h7_0_50->SetLineWidth(4);
  h7_0_50->SetLineColor(1004);

  h7_0_25->SetStats(0);
  h7_0_25->SetLineColor(1002);
  h7_0_25->SetLineWidth(4);

  h7_2_25->SetStats(0);
  h7_2_25->SetLineColor(1005);
  h7_2_25->SetLineWidth(4);

  h5_3_50->SetStats(0);
  h5_3_50->SetLineColor(1000);
  h5_3_50->SetLineWidth(4);
  ...
  if (!T2tt) h5_3_50->Draw("hist,same");
  ...
  TString tail;
  if (T2tt) tail="_compare_T2tt_1120.pdf";
