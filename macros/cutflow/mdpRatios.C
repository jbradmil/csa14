...
TString qcd_files[nSamples] = 
  {
    "reduced_trees/QCD_Pt-30to50*v75.root",
    "reduced_trees/QCD_Pt-50to80*v75.root",
    "reduced_trees/QCD_Pt-80to120*v75.root",
    "reduced_trees/QCD_Pt-120to170*v75.root",
    "reduced_trees/QCD_Pt-170to300*v75.root",
    "reduced_trees/QCD_Pt-300to470*v75.root",
    "reduced_trees/QCD_Pt-470to600*v75.root",
    "reduced_trees/QCD_Pt-600to800*v75.root",
    "reduced_trees/QCD_Pt-800to1000*v75.root",
    "reduced_trees/QCD_Pt-1000to1400*v75.root",
    "reduced_trees/QCD_Pt-1400to1800*v75.root",
    "reduced_trees/QCD_Pt-1800to2400*v75.root",
    "reduced_trees/QCD_Pt-2400to3200*v75.root",			
    "reduced_trees/QCD_Pt-3200*v75.root"
  };
...
TGraphAsymmErrors* GetCombinedEfficiency(const TString cut = "min_delta_phi_met_N>4.", TCut xtra_cuts="")
{ 
  
  TH1::SetDefaultSumw2();

  const int nbins=2;
  const double varbins[nbins+1]={0,400,1000};
  ...
  TFile *fout = new TFile("macros/cutflow/mdp_ratio_output.root", "recreate");
  fout->cd();
...
void mdpRatios() {
  ...
  TGraphAsymmErrors* mdpN = GetCombinedEfficiency("min_delta_phi_met_N>4.","ht30>1000&&num_reco_veto_electrons==0&&num_reco_veto_muons==0&&num_csvm_jets>1&&num_jets_pt30>=8");
  TGraphAsymmErrors* mdp = GetCombinedEfficiency("min_delta_phi_met>0.3","ht30>1000&&num_reco_veto_electrons==0&&num_reco_veto_muons==0&&num_csvm_jets>1&&num_jets_pt30>=8");
  ...
  thecanvas->Print("macros/cutflow/plots/mdp_ratio_test_T1tttt_8j30_cuts.pdf");
