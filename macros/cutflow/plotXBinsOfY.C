...
void plotXBinsOfY(const TString xvar = "num_jets_pt30", int nbinsx = 15, double xlow=0., double xhigh=15., const TString yvar = "met", TString xAxisTitle="n_{jets} (p_{T} > 30 GeV)", TString yLegLabel = "E_{T}^{miss}", const TString treestring = "reduced_trees/QCD*v75*.root", const TString plotNote="qcd", const TCut xtraCuts="", bool logy = false) 
{ 
  ...
  TCut baseline ="ht30>=1000&&num_reco_veto_muons==0&&num_reco_veto_electrons==0&&num_csvm_jets30>1&&num_jets_pt50>5";
