...
void ZBiWithTauScatterPlot(const TString yvar = "met", int nbinsy = 20, double ylow=0., double yhigh=1000., const TString xvar = "ht30", int nbinsx = 20, double xlow=0., double xhigh=2000., TString axistitles="H_{T} [GeV];E_{T}^{miss} [GeV]", const TCut cuts="num_jets_pt30>=4", const TString plotNote="4j_2b") 
{
  ...
  convert_to_ZBi_with_tau_2D(h2ZBi, h2, h2BG, nbinsx, xlow, xhigh, nbinsy, ylow, yhigh,10);
  h2ZBi->Draw("colz");
  thecanvas->Print("macros/cutflow/plots/scatter/ZBi_with_tau/R10/t1tttt_1500_100/"+yvar+"_vs_"+xvar+"_"+plotNote+"_t1tttt_1500_100_ZBi_1118_5ifb_3evt_with_tau.pdf");
  t1tttt_1200_800_ch->Draw(yvar+":"+xvar+">>h2",weighted_selection,"colz");
  convert_to_ZBi_with_tau_2D(h2ZBi, h2, h2BG, nbinsx, xlow, xhigh, nbinsy, ylow, yhigh,10);
  h2ZBi->Draw("colz");
  thecanvas->Print("macros/cutflow/plots/scatter/ZBi_with_tau/R10/t1tttt_1200_800/"+yvar+"_vs_"+xvar+"_"+plotNote+"_t1tttt_1200_800_ZBi_1118_5ifb_3evt_with_tau.pdf");
  t1bbbb_1500_100_ch->Draw(yvar+":"+xvar+">>h2",weighted_selection,"colz");
  convert_to_ZBi_with_tau_2D(h2ZBi, h2, h2BG, nbinsx, xlow, xhigh, nbinsy, ylow, yhigh,10);
  h2ZBi->Draw("colz");
  thecanvas->Print("macros/cutflow/plots/scatter/ZBi_with_tau/R10/t1bbbb_1500_100/"+yvar+"_vs_"+xvar+"_"+plotNote+"_t1bbbb_1500_100_ZBi_1118_5ifb_3evt_with_tau.pdf");
  t1bbbb_1000_900_ch->Draw(yvar+":"+xvar+">>h2",weighted_selection,"colz");
  convert_to_ZBi_with_tau_2D(h2ZBi, h2, h2BG, nbinsx, xlow, xhigh, nbinsy, ylow, yhigh,10);
  h2ZBi->Draw("colz");
  thecanvas->Print("macros/cutflow/plots/scatter/ZBi_with_tau/R10/t1bbbb_1000_900/"+yvar+"_vs_"+xvar+"_"+plotNote+"_t1bbbb_1000_900_ZBi_1118_5ifb_3evt_with_tau.pdf");
  t1qqqq_1400_100_ch->Draw(yvar+":"+xvar+">>h2",weighted_selection,"colz");
  convert_to_ZBi_with_tau_2D(h2ZBi, h2, h2BG, nbinsx, xlow, xhigh, nbinsy, ylow, yhigh,10);
  h2ZBi->Draw("colz");
  thecanvas->Print("macros/cutflow/plots/scatter/ZBi_with_tau/R10/t1qqqq_1400_100/"+yvar+"_vs_"+xvar+"_"+plotNote+"_t1qqqq_1400_100_ZBi_1118_5ifb_3evt_with_tau.pdf");
  t1qqqq_1000_800_ch->Draw(yvar+":"+xvar+">>h2",weighted_selection,"colz");
  convert_to_ZBi_with_tau_2D(h2ZBi, h2, h2BG, nbinsx, xlow, xhigh, nbinsy, ylow, yhigh,10);
  h2ZBi->Draw("colz");
  thecanvas->Print("macros/cutflow/plots/scatter/ZBi_with_tau/R10/t1qqqq_1000_800/"+yvar+"_vs_"+xvar+"_"+plotNote+"_t1qqqq_1000_800_ZBi_1118_5ifb_3evt_with_tau.pdf");
