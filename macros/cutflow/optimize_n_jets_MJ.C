...
void optimize_n_jets_MJ(const TString sigName = "reduced_trees/SMS-T1tttt_2J_mGl-1500_mLSP-100*v75*.root", const TString bgName = "all", const TString plotNote="T1tttt_1500_100_met_200_ht40_1000", const TCut cuts="") 
{
  set_plot_style();
  ...
  TCut start(cuts+"met>200&&fatpT30_MJ>400&&num_csvm_jets30>1&&min_delta_phi_met_N>4&&num_reco_veto_muons==0&&num_reco_veto_electrons==0");
  ...
  if (sigName.Contains("tttt")) h_n30s_over_sqrt_b->SetMaximum(5);
  ...
  thecanvas->Print("macros/cutflow/plots/optimize_n_jets/n_jets_optimization_MJ_"+plotNote+".pdf");
