...
void compare_samples_lost_muon(TString var, TCut cuts, TString title, int nbinsx, float low, float high, bool logscale=false, TString comments="") {
  ...
  chain13->Add("../../reduced_trees/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola-Spring14miniaod-PU20bx25_POSTLS170_V5-v1-MINIAODSIM_mu_from_b.list.root");
  ...
  TString plotTitle = var+"lost_muon"+comments+"_mu_from_b_compare8and13TeV.pdf";
  c1->Print(plotTitle);
}
