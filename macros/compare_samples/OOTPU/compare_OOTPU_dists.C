...
void compare_samples(TString var, TCut cuts, TString title, int nbinsx, float low, float high, bool logscale=false, TString comments="") {
  ...
  chain13_25->Add("../../reduced_trees/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola-Spring14miniaod-PU20bx25_POSTLS170_V5-v2-MINIAODSIM.list.root");
  TChain* chain13_50 = new TChain("reduced_tree");
  chain13_50->Add("../../reduced_trees/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola-Spring14miniaod-PU_S14_POSTLS170_V6-v1_cfA_v72.list.root");
  ...
  TString plotTitle = var+"_"+comments+"compare8and13TeV.pdf";
  c1->Print(plotTitle);
}
